...
namespace ProjetoFinalMariaE.Controllers
{
    public class TipoProcedimentoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,TipoPrecedimentoNome")] TipoProcedimento tipoProcedimento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TipoPrecedimentoNome")] TipoProcedimento tipoProcedimento)
        {
