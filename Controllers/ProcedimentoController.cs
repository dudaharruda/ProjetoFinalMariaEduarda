...
namespace ProjetoFinalMariaE.Controllers
{
    public class ProcedimentoController : Controller
    {
        ...
        {
            ViewData["TipoProcedimentoId"] = new SelectList(_context.Set<TipoProcedimento>(), "Id", "TipoPrecedimentoNome");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,ProcedimentoNome,ProcedimentoObservacao,TipoProcedimentoId")] Procedimento procedimento)
        {
            ...
            ViewData["TipoProcedimentoId"] = new SelectList(_context.Set<TipoProcedimento>(), "Id", "TipoPrecedimentoNome", procedimento.TipoProcedimentoId);
            return View(procedimento);
        }
