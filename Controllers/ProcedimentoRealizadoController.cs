...
namespace ProjetoFinalMariaE.Controllers
{
    public class ProcedimentoRealizadoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ClienteId,ProcedimentoId,ColaboradorId,LocalRealizacaoId,DataRealizacao")] ProcedimentoRealizado procedimentoRealizado)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ClienteId,ProcedimentoId,ColaboradorId,LocalRealizacaoId,DataRealizacao")] ProcedimentoRealizado procedimentoRealizado)
        {
